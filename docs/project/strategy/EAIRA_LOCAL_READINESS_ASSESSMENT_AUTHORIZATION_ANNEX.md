...
Version 0.25.0 is a targeted correction of the stale Section 16 lifecycle instruction only. It preserves Version 0.24.0 as historical shared WSL Git package-adoption synchronization evidence and changes no substantive planning model, requirement, category, criterion, Field, blocker, gate, task, command, envelope, reproduction record, or mapping. Version 0.25.0 requires independent complete-file, exact-diff, commit, blob, and remote-publication verification before any later Project Owner decision.
