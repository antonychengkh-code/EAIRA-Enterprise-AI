...
Main Annex Version `0.28.0`, dated `2026-07-22`, is the current independently verified publication at commit `6768d85c050d50aa52e8f25c7a46accc28977aba`, parent `92e6e1301fbbda4ece47b4ed9fa26970c1358d5b`, blob `7050272035646fd7c2870f77737a1b4a729694c2`. Phase A and Phase B are accepted only as documentary Field 9 and Field 8 frameworks; every individual proposed matrix value and decision option remains unselected. Publication verification and the read-only downstream impact review are complete, and exact six-file baseline capture fixed the pre-mutation blobs under archive SHA-256 `A4EDE9CD6F9212ED84349442B7EF5CEE990B7D2DBEA7AD74ED68391D8A18C802`.
...
The shared WSL Git package and adoption decision remain recorded. Annex Versions `0.24.0`, `0.25.0`, `0.26.0`, and `0.27.0` remain version-specific historical evidence. Main Annex Version `0.28.0`, commit `6768d85c050d50aa52e8f25c7a46accc28977aba`, parent `92e6e1301fbbda4ece47b4ed9fa26970c1358d5b`, blob `7050272035646fd7c2870f77737a1b4a729694c2`, is the current independently verified publication. Direct Git evidence established the one-file publication, matching local and remote `master`, clean working tree, and repository integrity; GitHub connector readback remained unavailable with `404 Not Found`; the verification response is not a repository artifact.
...
This bounded six-file downstream synchronization updates current-state and task artifacts only to the independently verified Main Annex Version `0.28.0` publication and B2-MAN-006 Field 8 / Field 9 prerequisite-package adoption chain. Its exact commit identity, changed-file set, resulting blobs, and remote publication require post-change independent Git verification. The same task remains active with unchanged status for bounded planning. After post-change verification, selection of the next specific bounded planning scope returns to the Project Owner.
